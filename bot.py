...
def main():
    ...
    # ==================================================
    # 修正：ランキングURLではなく「トップページ」を使用（確実性重視）
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            for link in links:
                ...
                # 短すぎず、長すぎず、「？」で終わるものなどを優先したいが、
                # 単純に文字数でフィルタリングするのが一番汎用性が高い
                if 10 < len(text) < 50:
                    topics.append(text)
    ...
    try:
        ...
        print(f"❌ 投稿失敗：{e}")
        # もしまた403が出たら、それは「リンク」ではなく「鍵」の問題であることを通知
        if "403" in str(e) or "Forbidden" in str(e):
            print("🛑 重要: リンクの問題は解決しましたが、X側の投稿許可が下りていません。GitHubの鍵が古い可能性があります。")

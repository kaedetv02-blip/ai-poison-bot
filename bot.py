...
def main():
    ...
    2. **ターゲット層**: 
       * **中高生・大学生**が読んで「あるあるｗｗ」「それな」と共感できる内容にしてください。
    ...
    3. **不祥事の内容（超重要）**: 
       ...
       **【笑える具体例】**
       ⭕️「テスト範囲の『P.30〜P.50』を、**『P.30とP.50だけ』やればいいと都合よく解釈**し、結果として白紙の答案を提出しました」
       ⭕️「好きな人へのLINEを送信取り消ししようとして、**誤って『削除（自分だけ消える）』を押してしまい、永遠に履歴に残るデジタルタトゥー**を刻みました」
       ⭕️「『行けたら行く』という言葉を信じ、**集合場所のマックで4時間待ち続けた**結果、ポテトのLサイズを3つ完食してしまいました」
       ⭕️「スマホの充電が1%しかない状態で、**命がけのスクショ**を試み、その瞬間に電源が落ちて世界が闇に包まれました」
